/*
  ...
  - Added the required column `isNeedOperator` to the `Quotation` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Quotation" ("amount", "clientId", "createdAt", "days", "deliveryAmount", "description", "id", "igv", "operatorId", "platformId", "quotationPath", "status", "subtotal", "total", "typeCurrency", "updatedAt") SELECT "amount", "clientId", "createdAt", "days", "deliveryAmount", "description", "id", "igv", "operatorId", "platformId", "quotationPath", "status", "subtotal", "total", "typeCurrency", "updatedAt" FROM "Quotation";
